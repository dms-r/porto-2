...
export default async function PostPage({ params }: Props) {
  ...
  return (
    <PageWrapper>
      <article className="max-w-3xl mx-auto animate-fadeIn prose dark:prose-invert lg:prose-lg">
        ...
        <div
          className="prose-p:text-foreground prose-headings:text-primary prose-a:text-accent prose-strong:text-foreground"
